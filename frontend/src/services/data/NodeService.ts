...
// Tipo específico para TreeTable
...
export const NodeService = {
    getTreeNodesData(): TreeNode<string>[] {
        return [
            {
                key: '0',
                label: 'Documents',
    ...
    getTreeTableNodesData(): TreeNode<TreeTableNodeData>[] {
        return [
            {
                key: '0',
            ...
            },
            {
                ...
                children: [
                    ...
                    { key: '6-1', data: { name: 'logo.png', size: '2kb', type: 'Picture' } }
                ]
            },
            {
                key: '7',
                ...
                children: [
                    { key: '7-0', data: { name: 'barcelona.jpg', size: '90kb', type: 'Picture' } },
                    { key: '7-1', data: { name: 'primevue.png', size: '30kb', type: 'Picture' } },
                    { key: '7-2', data: { name: 'prime.jpg', size: '30kb', type: 'Picture' } }
                ]
            },
            {
                key: '8',
                ...
                children: [
                    { key: '8-0', data: { name: 'primefaces.mkv', size: '1000kb', type: 'Video' } },
    ...
    getTreeNodes(): Promise<TreeNode<string>[]> {
        return Promise.resolve(this.getTreeNodesData());
    },

    getTreeTableNodes(): Promise<TreeNode<TreeTableNodeData>[]> {
