...
function expandAll(): void {
    expandedRows.value = purchaseStore.purchases
                ...
                <div class="card">
                    ...
                    >
                        ...
                        <template #expansion="slotProps">
                            <div class="p-4">
                                <h5 class="mb-4">Produtos da compra {{ slotProps.data.invoice_number }}</h5>
                                <DataTable v-if="slotProps.data.products && slotProps.data.products.length > 0" :value="slotProps.data.products">
                                    ...
                                    <Column field="total" header="Quantidade" sortable>
                                        <template #body="productSlot">
                                            <Tag :value="productSlot.data.total" severity="success" />
                                        </template>
                                    </Column>
