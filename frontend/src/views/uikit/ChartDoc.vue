...
const lineData = ref<ChartData<'line'> | null>(null);
const pieData = ref<ChartData<'pie'> | null>(null);
const polarData = ref<ChartData<'polarArea'> | null>(null);
const barData = ref<ChartData<'bar'> | null>(null);
const radarData = ref<ChartData<'radar'> | null>(null);

const lineOptions = ref<ChartOptions<'line'> | null>(null);
const pieOptions = ref<ChartOptions<'pie'> | null>(null);
const polarOptions = ref<ChartOptions<'polarArea'> | null>(null);
const barOptions = ref<ChartOptions<'bar'> | null>(null);
const radarOptions = ref<ChartOptions<'radar'> | null>(null);
