...
const picklistProducts = ref<[Product[], Product[]] | null>(null);
const orderlistProducts = ref<Product[] | null>(null);
...
function getSeverity(product: Product): 'success' | 'warning' | 'danger' | null {
