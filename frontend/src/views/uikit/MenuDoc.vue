...
const menu = ref<InstanceType<(typeof import('primevue/menu'))['default']> | null>(null);
const contextMenu = ref<InstanceType<(typeof import('primevue/contextmenu'))['default']> | null>(null);
...
const breadcrumbItems = ref<BreadcrumbItem[]>([{ label: 'Computer' }, { label: 'Notebook' }, { label: 'Accessories' }, { label: 'Backpacks' }, { label: 'Item' }]);

const tieredMenuItems = ref<MenuItem[]>([...nestedMenuitems.value, { separator: true }, { label: 'Quit', icon: 'pi pi-fw pi-sign-out' }]);

const overlayMenuItems = ref<MenuItem[]>([{ label: 'Save', icon: 'pi pi-save' }, { label: 'Update', icon: 'pi pi-refresh' }, { label: 'Delete', icon: 'pi pi-trash' }, { separator: true }, { label: 'Home', icon: 'pi pi-home' }]);
...
const contextMenuItems = ref<MenuItem[]>([{ label: 'Save', icon: 'pi pi-save' }, { label: 'Update', icon: 'pi pi-refresh' }, { label: 'Delete', icon: 'pi pi-trash' }, { separator: true }, { label: 'Options', icon: 'pi pi-cog' }]);
...
const panelMenuitems = ref<MenuItem[]>([...nestedMenuitems.value]);
